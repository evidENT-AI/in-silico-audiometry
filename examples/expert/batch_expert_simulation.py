"""Batch simulation script for analyzing expert audiometry performance across different conditions."""
...
def main():
    ...
    # Save raw results
    results_df.to_csv('/Users/liambarrett/Evident-AI/audiometry_ai/results/examples/expert_simulation_results.csv', index=False)
    ...
    for i, fig in enumerate(figures):
        fig.savefig(f'/Users/liambarrett/Evident-AI/audiometry_ai/results/examples/expert_simulation_plot_{i}.png')
        plt.close(fig)
